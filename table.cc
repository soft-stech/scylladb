...
table::query(schema_ptr s,
    ...
    while (!qs.done()) {
        ...
        if (!querier_opt) {
            query::querier_base::querier_config conf(_config.tombstone_warn_threshold, _config.tombstone_failure_threshold, qs.cmd.query_string);
...
table::mutation_query(schema_ptr s,
    ...
    if (!querier_opt) {
        query::querier_base::querier_config conf(_config.tombstone_warn_threshold, _config.tombstone_failure_threshold, cmd.query_string);
